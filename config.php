...
$mongoCertificatesCollectionName = getenv('MONGODB_CERTIFICATES_COLLECTION') ?: 'certificados';
...
try {
    ...
    $coleccionCertificados = $baseDeDatos->selectCollection($mongoCertificatesCollectionName);
